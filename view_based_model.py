...
def plot_durations(durations, epsilons):
    plt.figure(2)
    plt.clf()
    plt.title('Training...')
    plt.xlabel('Episode')
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if reward == 0:
            ...
            episode_epsilons.append(policy.get_epsilon())
            plot_durations(episode_durations, episode_epsilons)
            duration = 0
            state = env.reset()
